...
/// on in white, the chosen one in grey once focus has moved on — the same
/// language as the tab bar, and the focus behaviour comes for free. The pills
/// it replaced were three buttons of ours, and keeping focus on the one just
