...
| Provisioning profile | `TV Scores tvOS App Store 2` (`3YA4WZL5X6`), expires 2027-09-14 — minted 2026-09-19 with the User Management capability; build 19 shipped on it and the first profile was deleted |
